...
def node_average_gc(inputs, adj_mtx, activation, filters=None, trainable=True):
    ...
    print("center: ", center_weights.shape)
    print("neighbor: ", neighbor_weights.shape)
...
def node_single_weight_gc(inputs, adj_mtx, activation, filters=None, trainable=True):
    # node_single_weight_gc_dist_thresh
